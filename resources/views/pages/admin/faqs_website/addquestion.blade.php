...
<!-- Page body start -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                  <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                    <a class="navbar-brand">Add Question</a>
                     ...
                     <!-- Default Navbar card end -->
								...
								<form id="exhibition_form_add_main" action="{{route('QuestionFaq_store')}}" method="post" id="modal-form"  enctype="multipart/form-data">
								{{ csrf_field() }}                        <!-- Row start -->
                             <input type="hidden" name="faq_id" id ="faqid" value="{{$faqid}}">
                             <input type="hidden" name="faqlang" id ="faqid" value="{{$faqlang}}">
  ...
  <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input id="title" name="title" type="text"  class="form-control thresold-i form-control-info" placeholder="Title " maxlength="100" value="{{old('title')}}" required>
                                    </div>
                                  </div>
             ...
             <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <label for="title">Content</label>
                                         ...
                                         <textarea  id ="editor" name="content" class="form-control thresold-i form-control-info" placeholder=" Content " rows="5" required></textarea>
                          ...
                          <div class="row">
                                  ...
                                  <select class="selectsingle col-sm-12" name="active"  id="active" required>
								...
								<center><button class="btn btn-info btn-round">Add Question</button></center>
								</form> 
