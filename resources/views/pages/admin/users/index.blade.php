...
<script>
    ...
    $('#AddModal').find('.modal-body').append('<p id="dangermsgadd"><span class="text-danger"><b>Email Must be unique</b></span></p>');
...
<script>
    ...
    $('#EditModal').find('.modal-body').append('<p id="dangermsg"><span class="text"><b>Email Already Existed</b></span></p>');
...
<script>
    ...
    $('#EditModal_{{Session::get('user_id')}}').modal('show');

    $('#EditModal_{{Session::get('user_id')}}').find('.modal-body').append('<p id="dangermsg"><span class="text-danger"><b>There is something wrong in name or code</b></span></p>');

   

 $('#EditModal_{{Session::get('user_id')}}').on('hide.bs.modal', function(){
                        ...
                        <div class="card">
                            <div class="card-block">
                                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                    <a class="navbar-brand">Members Section  View</a>
                                    ...
                                    <div class="collapse navbar-collapse"
                                        ...
                                        <ul class="navbar-nav mr-auto">
                                            <li class="nav-item active">
                                                <a class="nav-link">All Members  <span
...
<!-- <a  class="btn buttonadd " data-toggle="modal" data-target="#AddModal">Add Users</a> -->
                                <!-- Row start -->
                                <div class="row">
                                    <div class="col-lg-12 col-xl-12">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table  class="table table-striped table-bordered nowrap Members">
                ...
                <h4 class="modal-title w-100 font-weight-bold">Edit Member</h4>
               ...
               <form  action="{{route('User_edit')}}" method="post" id="Editmodal-form">
                ...
                <div class="modal-body mx-3">
                  ...
                  <label for="inputCategoryName" class="col-sm-2 col-form-label">User Name</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control"  placeholder="User Name" value="{{ old('name') }}" name="username" >
                  </div>
                  </div>
                
                  <div class="form-group row">
                  <label for="inputCategoryName" class="col-sm-2 col-form-label">Email</label>
                  <div class="col-sm-10">
                  <input type="email" class="form-control"  placeholder="Email" value="{{ old('email') }}" name="email" >
                    ...
                    <div class="form-group row">
                  <label for="inputCategoryName" class="col-sm-2 col-form-label">Wallet</label>
                  <div class="col-sm-10">
                  <input type="number" class="form-control"  placeholder="Wallet" value="{{ old('wallet') }}"  name="wallet" >
                  </div>
                  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Confirm User <span class="text-danger"><b>Deleting</b></span> ?</p>
      </div>
...
<div class="modal fade" id="ChangeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Confirm User <span class="text-danger"><b>Password</b></span> ?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
        <a id="delete_submit" class="waves-light waves-effect btn btn-info" data-dismiss="modal" href="#">Yes</a>
...
<form id="change_form_id" action="{{route('User_delete')}}" method="post">
  @csrf
  <input type="hidden" style="diplay:none;" id="user_idchange" name="user_id" value="">
</form>

<form id="delete_form_id" action="{{route('User_delete')}}" method="post">
  @csrf
  <input type="hidden" style="diplay:none;" id="user_iddelete" name="user_id" value="">
</form>



<form id="active_form_id" action="{{route('User_active')}}" method="post">
  @csrf
  <input type="hidden" style="diplay:none;" id="user_id" name="user_id" value="">
</form>
<!--  add country modal -->
    ...
    <div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="AddModal" aria-hidden="true" class="AddModal">
                ...
                <form  action="{{route('User_add')}}" method="post" id="modal-form" id='AddUsersForm'>
                  @csrf
                <div class="modal-body mx-3">
                  ...
                  <div class="col-sm-10">
                  <input type="text" id ="AddName" class="form-control" id="inputUserName" placeholder="User Name" name="name" value="{{ old('name') }}" required>
                  </div>
                  </div>
                  <div class="form-group row">
                  <label for="inputCodeName" class="col-sm-2 col-form-label">Email</label>
                  <div class="col-sm-10">
                  <input type="email" id ="AddEmail" class="form-control" id="inputEmailName" placeholder="Email" name="email" value="{{ old('email') }}" required>
                  </div>
                  </div>

                <div class="form-group row">
                  <label for="inputCodeName" class="col-sm-2 col-form-label">Password</label>
                  <div class="col-sm-10">
                   <input type="password" id="password" class="form-control" placeholder="password" name='password' pattern="[a-zA-Z0-9]+" title="Dont Contain Whitespaces" required>

                  </div>
                  </div>

                   <div class="form-group row">
                  <label for="inputCodeName" class="col-sm-2 col-form-label">Confirm Password</label>
                  <div class="col-sm-10">
                    <input type="password" id="confirm_password" class="form-control" placeholder="password"  autofocus="" required>
               ...
               <span id="confirm_password_msg"></span>
                ...
                <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-indigo " id='addusers'>Add Users <i class="fas fa-paper-plane-o ml-1"></i></button>
                </div>
                </form>
...
<script type="text/javascript">
  ...
  var email=$(opener).attr('user-email');
 var active=$(opener).attr('active-id');
 var wallet=$(opener).attr('wallet');
 var username=$(opener).attr('username');


//set what we got to our form
  $('#Editmodal-form').find('[name="email"]').val(email);
   $('#Editmodal-form').find('[name="activeedit"]').val(active);
 $('#Editmodal-form').find('[name="wallet"]').val(wallet);
$('#Editmodal-form').find('[name="useridedit"]').val(userid);
   $('#Editmodal-form').find('[name="username"]').val(username);
...
<script type="text/javascript">
	     ...
	     check_Passwordedit( $("#passwordedit_"+id).val(), $("#confirm_passwordedit_"+id).val(),id )

	      function check_Passwordedit( Pass, Con_Pass,id){

	      	console.log( Pass, Con_Pass,id);
          ...
          if(Pass === ""){
            ...
            $('#confirm_password_msgedit_'+id).show()
            $("#confirm_password_msgedit_"+id).html('<div class="alert alert-success">Password matched</div>')
 $("#edituser_"+id).removeAttr("disabled");
            setTimeout(function() {
                $('#confirm_password_msgedit_'+id).fadeOut('slow');
            }, 3000000);

          }else{
            $("#confirm_passwordedit_"+id).focus()
            $('#confirm_password_msgedit_'+id).show()
            $("#confirm_password_msgedit_"+id).html('<div class="alert alert-danger">Password didnot matched</div>')
  $("#edituser_"+id).attr("disabled", "disabled");



            setTimeout(function() {
                $('#confirm_password_msgedit').fadeOut('slow');
            }, 300000000);
...
<script type="text/javascript">
 ...
 $("#addusers").removeAttr("disabled");
  ...
  $("#addusers").attr("disabled", "disabled");
