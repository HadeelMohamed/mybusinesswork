                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                  <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                    <a class="navbar-brand">Add Main Data to Tips</a>
                                    ...
                                    <div class="collapse navbar-collapse"
                                        ...
                                        <ul class="navbar-nav mr-auto">
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{route('Exhibition_list')}}">All Business Tips </a>
                                            </li>
                     ...
                     <!-- Default Navbar card end -->
								...
								<form id="exhibition_form_add_main" action="{{route('Tips_add')}}" method="post" id="modal-form"  enctype="multipart/form-data">
								...
								<img id="blah" src="{{asset('website/images/')}}/download.png" alt="your image" style="height: 60%;" />
								</div>
								...
								<center><button class="btn btn-info btn-round">Add Main Tips Data</button></center>
								</form> 
