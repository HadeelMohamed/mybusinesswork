...
.form-control, .nice-select{
    ...
    box-shadow: 1px 1px 5px #b5adad;
      ...
      <div>
        <a class="a-tabs a-tabs-active" href="{{url('/')}}/{{LaravelLocalization::getCurrentLocale()}}/Exhibition/join_exhibitor/{{$exh_slug}},2">@lang('website.exhibitor_information')</a>  <a class="a-tabs " href="{{url('/')}}/{{LaravelLocalization::getCurrentLocale()}}/Exhibition/join_exhibitor_products/{{$exh_slug}}">@lang('website.products')</a>
      </div>
