...
.form-control, .nice-select{
  ...
  <div class="container-dashborad">
   ...
   <form id="update_member_form" action="{{url('/')}}/{{LaravelLocalization::getCurrentLocale()}}/Exhibition/join_exhibitorPost" method="post" enctype="multipart/form-data">
    ...
    @csrf
    <input id="exh_session" hidden="" name="exh_session" value="">
...
<div class="row">
  <div class="col-12">
    <br>
    <center><a id="update_btn" class="btn btn-danger text-white">@lang('website.next_step')</a></center>
  </div>
</div>
   </article>
...
$(document).ready(function(){
  ...
  $('#exh_session').val(exh_slug_session);
...
sessionStorage.clear();
  ...
  //       // Move to a new location or you can do something else
  //       // window.location.href = "https://www.google.co.in";
  //       condole.log('https://www.google.co.in');
