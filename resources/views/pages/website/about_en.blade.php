  ...
  <div class="card border-card">
    <div class="card-header back-accordion" id="headingTwo">
      <h2 class="head-accordion" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          What do I get from MyBusiness membership?
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample2">
      ...
      <li>If you are (an individual or company) you will get a trading account, your 
...
level with ease while you are in your place.
</li>
...
<li>Use our Services (online exhibitions – online auctions  – online tenders 
....).
</li>
...
Exhibition, while you are in your place just using the internet, and get 
...
work and services with the following steps:-
    ...
    <br>
    <div class="col-lg-12">Enter the Exhibitions page and find available exhibitions according to 
...
<br>
<div class="col-lg-12">(Exhibition name – Exhibition area – Start date – End date – 
exhibition information – companies and exhibitors who have already 
booked a booth – sponsors – Number of products and services added to the 
show).
</div>
<br>
...
<li>Promotion`s and promotion of the trademark</li>
<li>Identify new technology in the market.</li>
<li>Study of competitors.</li>
<li>Make a database for customers and those interested in the market.</li>
<li>International exhibitions are a favorable environment for investment 
...
How to register?
    ...
    <h6><b>How to register?</b></h6>
      <div class="card-body">
      <ul class="ul-accodion">
      <li>Login to MyBusiness website www.mybusinessme.com</li>
