...
.form-control, .nice-select{
  ...
  <div class="container-dashborad">
   ...
   @endif
   <form id="update_member_form" action="{{route('MemberExhibitorDetailsUpdate')}}" method="post" enctype="multipart/form-data">
    @csrf
...
<div class="row">
  <div class="col-12">
    <br>
    <center><a id="update_btn" class="btn btn-danger text-white">@lang('website.update')</a></center>
  </div>
</div>
   </article>
