		...
		<!--   ....................article....................-->
			<article class="col-md-9">
				<div class="container-dashborad">
				  ...
				  --}}
					<div class="form-group">
						<input hidden="" id="product_id" value="{{$product_details->id}}">
                    ...
                    <div class="row" id="photos_viewers">
                    	@if(isset($galleries))
                  		@foreach($galleries as $gallery)
											<div id="{{$gallery->image}}" class="col-lg-3 col-md-4 col-6">
												<center><i class="fas fa-trash-alt btn btn-danger" onclick="delete_image_name('{{$gallery->image}}')"></i></center>
												<img class="pro_img_preview" src="{{url('/')}}/images/en/products_gallery/med/{{$gallery->image}}" width="150" height="150">
											</div>
                      @endforeach
                      @endif
                    </div>
...
<!-- <button id="add_new_photo_ajax" style="margin-top: 10px; display: none;" class="btn btn-danger">Add Photo</button> -->
					  ...
					  <button type="button" id="UpdateProFormOneBtn" class="btn btn-danger">@lang('website.update')</button>
...
<form id="ProImagesForm" method="post" action="" enctype="multipart/form-data">
	...
	<!-- <table class="table table-bordered table-striped" style="margin-top:10px;" id="pro_images_list">
				...
				<!-- <div class="row">
					<div class="col-12">
						<center>
							<a id="all_products_list_btn" style="display:none;" class="btn btn-secondary btn-danger btn-sm btn-cus" href="{{route('Authed_Member_Products')}}">@lang('website.save')</a>
							<a style="display:none;" id="GoToNewProduct" href="{{route('Authed_Member_Products_Create')}}" class="btn btn-secondary btn-sm btn-cus"><i class="fas fa-plus"></i> @lang('website.add_new_product')</a>
						</center>
					</div>
				</div> -->
			</article>
...
$("#pro_name").on("keypress",function (event) { 
  ...
  if(n == true){
	...
	$('#UpdateProFormOneBtn').click(function(){
...
<script>
    ...
    function upload(img) {
      ...
      form_data.append('pro_id',product_id);
      ...
      $.ajax({
          ...
          success: function (data) {
              if (data.fail) {
                ...
                $('#photos_viewers').append('<div id='+data1+' class="col-lg-3 col-md-4 col-6"><center><i class="fas fa-trash-alt btn btn-danger" onclick="delete_image_name('+data1+')"></i></center><img class="pro_img_preview" src="{{url('/')}}/images/en/products_gallery/med/'+data+'" width="150" height="150"></div>');
              }
