        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.fail) {
                  ...
                  $('#photos_viewers').append('<div class="col-lg-3 col-md-4 col-6"><center><i class="fas fa-trash-alt btn btn-danger" onclick="delete_image_name('+data1+')"></i></center><img class="pro_img_preview" src="{{url('/')}}/images/en/products_gallery/med/'+data+'" width="150" height="150"></div>');
                }
