...
<li> التواصل مع جميع الشركات المدرجة في دليل أعمال   MyBusinessوبالتالي 
...
<li>استخدام خدماتنا ( معارض على الإنترنت – مزادات أون لاين – مناقصات أون 
لاين ....).
</li>
      </ul>
...
الناجحة
  ...
  <div class="card border-card">
    ...
    <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample3">
      <div class="card-body">
    <div class="row">
    <div class="col-lg-12">يمكنك الإشتراك في أحد المعارض المحلية أوالدولية والإختيار بين أن تكون 
...
كيفية التسجيل؟
    ...
    <h6><b>لكي تنشئ حساب على موقع MyBusiness</b></h6>
      <div class="card-body">
      <ul class="ul-accodion">
      <li>إدخل علي موقعwww.mybusinessme.com My Business</li>
      ...
      <h6><b>تهانينا، لقد أتممت تسجيل حسابك</b></h6>
      </div>
