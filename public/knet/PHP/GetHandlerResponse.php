...
/* NOTE - MERCHANT MUST LOG THE RESPONSE RECEIVED IN LOGS AS PER BEST PRACTICE */	
	...
	/*IMPORTANT NOTE - MERCHANT SHOULD UPDATE 
		...
		header("Location: https://mybusinessme.com/Account/knet/result".$decrytedData);
                exit();
		}
	}
	else{
				header("Location: https://mybusinessme.com/Account/knet/result"."Error=".$ResErrorNo."&ErrorText=".$ResErrorText."&trackid=".$ResTrackID."&amt=".$ResAmount."&paymentid="+$ResPaymentId);
                exit();
	}
