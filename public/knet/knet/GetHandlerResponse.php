...
header("Location: https://mybusinessme.com/knet/knet/result.php?".$decrytedData);
exit();
}
else{
header("Location: https://mybusinessme.com/knet/knet/result.php?Error=".$ResErrorNo."&ErrorText=".$ResErrorText."&trackid=".$ResTrackID."&amt=".$ResAmount."&paymentid=".$ResPaymentId."&tranid=".$ResTranId."&result=".$ResResult);
exit();
}
